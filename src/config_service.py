...
class ConfigService:
    ...
    def get_entry_price_offset_pips(self):
        """
        Returns the configured entry price offset in PIPS (float).
        Defaults to 0.0 if missing or invalid.
        """
        return self.getfloat('Trading', 'entry_price_offset_pips', fallback=0.0)
